...
var deleteFromCart = document.querySelectorAll('.delete-from-cart');
var cartCounter = document.querySelector('#cartCounter');

function updateCart(merch) {
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/update-cart', merch).then(function (res) {
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var merch = JSON.parse(btn.dataset.merch);
    updateCart(merch);
  });
});

function deleteCart(merch) {
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/delete-cart', merch).then(function (res) {
    cartCounter.innerText = res.data.totalQty;
  })["catch"](function (err) {
    new noty__WEBPACK_IMPORTED_MODULE_1___default.a({
      type: 'error',
...
deleteFromCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var merch = JSON.parse(btn.dataset.merch);
    deleteCart(merch);
  });
...
function updateStatus(order) {
  ...
  statuses.forEach(function (status) {
    ...
    if (dataProp === order.status) {
      stepCompleted = false;
      time.innerText = moment__WEBPACK_IMPORTED_MODULE_3___default()(order.updatedAt).format("MM.DD.YYYY");
...
__webpack_require__(/*! C:\MELLI\weverse-shop\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\MELLI\weverse-shop\resources\scss\app.scss */"./resources/scss/app.scss");
